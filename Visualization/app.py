...
def redraw():
    ...
    frequency_line_graph = plot_frequency_line_graph(lang, lang, lang)
    ...
    language_pie_chart = plot_language_pie_chart(120574, 98358, 77643)
    ...
    sentiment_pie_chart = plot_sentiment_pie_chart(int(120574*0.7), int(120574*0.3), int(98358*0.6), int(98358*0.4), int(77643*0.65), int(77643*0.35))

    # Emotions Frequency Bar Chart
    # eng_emodf, chi_emodf, mal_emodf = get_emotions_count()
    emotions = pd.read_csv('data/emotions.csv')
    emotion_frequency_bar_chart = plot_emotion_frequency_bar_chart(emotions, emotions, emotions)
...
def chart():
    ...
    frequency_line_graph, sentiment_line_graph, language_pie_chart, sentiment_pie_chart, emotion_frequency_bar_chart, sentiment_by_day_bar_chart, emotion_over_time_bar_chart = redraw()
...
def plot_each_frequency_line_graph(dataset, cpalette=None):
    ...
    for name, color in zip(['nlikes', 'nreplies', 'nretweets', 'ntweets', 'nvideos'], Bokeh5):
